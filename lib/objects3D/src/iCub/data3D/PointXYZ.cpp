...
bool PointXYZ::read_x(yarp::os::idl::WireReader& reader) {
...
bool PointXYZ::nested_read_x(yarp::os::idl::WireReader& reader) {
  if (!reader.readDouble(x)) {
    reader.fail();
    return false;
  }
...
bool PointXYZ::read_y(yarp::os::idl::WireReader& reader) {
...
bool PointXYZ::nested_read_y(yarp::os::idl::WireReader& reader) {
  if (!reader.readDouble(y)) {
    reader.fail();
    return false;
  }
...
bool PointXYZ::read_z(yarp::os::idl::WireReader& reader) {
...
bool PointXYZ::nested_read_z(yarp::os::idl::WireReader& reader) {
  if (!reader.readDouble(z)) {
    reader.fail();
    return false;
  }
...
bool PointXYZ::write_x(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeDouble(x)) return false;
  return true;
}
bool PointXYZ::nested_write_x(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeDouble(x)) return false;
  return true;
}
bool PointXYZ::write_y(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeDouble(y)) return false;
  return true;
}
bool PointXYZ::nested_write_y(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeDouble(y)) return false;
  return true;
}
bool PointXYZ::write_z(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeDouble(z)) return false;
  return true;
}
bool PointXYZ::nested_write_z(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeDouble(z)) return false;
  return true;
}
...
bool PointXYZ::Editor::write(yarp::os::ConnectionWriter& connection) {
...
bool PointXYZ::Editor::read(yarp::os::ConnectionReader& connection) {
  if (!isValid()) return false;
  yarp::os::idl::WireReader reader(connection);
  reader.expectAccept();
...
yarp::os::ConstString PointXYZ::toString() {
  yarp::os::Bottle b;
  b.read(*this);
  return b.toString();
}
